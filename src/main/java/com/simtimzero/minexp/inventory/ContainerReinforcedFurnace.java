...
public class ContainerReinforcedFurnace extends Container {

    private TileEntityReinforcedFurnace tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerReinforcedFurnace(InventoryPlayer player, TileEntityReinforcedFurnace tileEntityFurnace){
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (p_82846_2_ != 1 && p_82846_2_ != 0)
            {
                ...
                else if (TileEntityReinforcedFurnace.isItemFuel(itemstack1))
                {
