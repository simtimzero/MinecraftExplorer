...
public class GuiReinforcedFurnace extends GuiContainer{

    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
    private TileEntityReinforcedFurnace tileFurnace;

    public GuiReinforcedFurnace(InventoryPlayer invPlayer, TileEntityReinforcedFurnace tile) {
        super(new ContainerReinforcedFurnace(invPlayer, tile));
