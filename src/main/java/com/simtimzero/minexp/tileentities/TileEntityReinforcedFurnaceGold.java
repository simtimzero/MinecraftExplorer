...
import com.simtimzero.minexp.block.ReinforcedFurnaceGold;
...
public class TileEntityReinforcedFurnaceGold extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.furnaceName : "Golden Reinforced Furnace";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.isBurning() && this.canSmelt())
            {
                ...
                //Changes Cook Time but does not update length of the Indicator in the Gui
                //To update the Gui See Container Class for the Entity "detectAndSendChanges"
        ...
        {
            flag1 = true;
            ReinforcedFurnaceGold.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            //Set Custom Furnace Recipes by replacing "FurnaceRecipes.smelting()"
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_)
    {
        ...
        else
        {
            ...
            if (item instanceof ItemHoe && ((ItemHoe)item).getToolMaterialName().equals("WOOD")) return 200 * 2;
            if (item == Items.stick) return 100 * 2;
            if (item == Items.coal) return 1600 * 2;
            if (item == Items.lava_bucket) return 20000 * 2;
            if (item == Item.getItemFromBlock(Blocks.sapling)) return 100 * 2;
            if (item == Items.blaze_rod) return 2400 * 2;
            return GameRegistry.getFuelValue(p_145952_0_) * 2;
        }
    }
