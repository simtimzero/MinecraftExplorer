...
import com.simtimzero.minexp.handler.MinExpFurnaceRecipes;
...
public class TileEntityReinforcedFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.furnaceName : "Reinforced Furnace";
    }
    ...
    public void updateEntity()
    {
        ...
        {
            flag1 = true;
            ReinforcedFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        }
